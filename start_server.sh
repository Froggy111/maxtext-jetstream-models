...
export M_LOAD_PARAMETERS_PATH=${PWD}/maxtext-models/${MODEL_NAME}-param-only/
export M_PER_DEVICE_BATCH_SIZE=96
...
export TOKENIZER_PATH=${PWD}/${MODEL_NAME}/tokenizer.model

python ${PWD}/multiprocess_server.py \
       ${PWD}/openhermes-2.5-config.yml \
